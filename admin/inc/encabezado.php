    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item <?php if($pagina=="inicial"){echo "active";} ?>">
			...
			<ul class="navbar-nav justify-content-end">
				<li class="nav-item">
					<a href="carrito.php" class="nav-link"><i class="fas fa-shopping-cart"></i> (<?php if(isset($_SESSION['unidades'])){ echo $_SESSION['unidades'];}else{ echo "0";} ?>)</a>
				</li>
			...
			?>
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Bienvenido <?php echo $_SESSION['admin']; ?></a>
			...
			?>
					<li class="nav-item">
						<a href="index.php" class="btn btn-outline-success my-2 my-sm-0">Identifícate</a>
					</li>
			<?php
				}
			?>
